...
#define DATAITEM_SIZE 			2000
#define TXN_SIZE 				200
#define CONFLICT_SIZE 			20
...
/* ****************************** New Data ****************************** */
/* ********************************************************************** */
extern PGDLLIMPORT  int									r_limit;
extern PGDLLIMPORT	int									searchWidth;
extern PGDLLIMPORT	int									searchDepth;
extern PGDLLIMPORT  int 								order_num;
extern PGDLLIMPORT  volatile	int 					index_current_txn;
extern PGDLLIMPORT 	struct 	DataMatrix* 				hashMatrix;   				
extern PGDLLIMPORT 	struct 	WriteMatrix* 				writeMatrix;
extern PGDLLIMPORT 	volatile struct DataItem* 			dataItem;	
