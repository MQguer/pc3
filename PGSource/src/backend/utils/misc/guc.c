...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"pc3", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow PCCC, recommend using it under SI."),
			NULL,
			GUC_EXPLAIN
		},
		&pc3,
		...
		
	{
		{"boolPrint", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow processes to print some logs."),
			NULL,
			GUC_EXPLAIN
		},
		&boolPrint,
	...
	{
		{"occ", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow OCC, recommend using it under SI."),
			NULL,
			GUC_EXPLAIN
		},
		&occ,
	...
	{
		{"pcc", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow PCC, recommend using it under SI."),
			NULL,
			GUC_EXPLAIN
		},
		&pcc,
